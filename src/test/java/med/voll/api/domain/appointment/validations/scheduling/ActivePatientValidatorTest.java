...
@ActiveProfiles("test")
class ActivePatientValidatorTest {
    ...
    @Test
    @DisplayName("Deve retornar true, pois não pode existir pacientes inativos")
    ...
    @Test
    @DisplayName("Deve retornar false, pois não pode existir pacientes inativos")
    ...
    @Test
    @DisplayName("Deve retornar false, pois não pode passar null no paciente")
    void valid_Scenario3() {
        ...
        Boolean active = !(scheduleDTO.idPatient() == null || repository.findActiveById(scheduleDTO.idPatient()));
